...
%% read 
analysis.circuitName = 'sram6Tcell';
analysis.path = pwd;
...
pfailMC = 1.24e-5; % target failurerate
nTest = 1e7;
...
name = length(Ytrain);
filename = strcat('/home2/soc/xcz/tensor/LRA18d-6-12/data/resultBitCell_',char(48+q), char(48+p));
id = cell(circuit,1);
for m = 1:circuit
    id{m} = m;
end
